...
window.Banco100 = (() => {
  ...
  function texInline(s){ return "\\(" + s + "\\)"; }
  function texBlock(s){ return "\\[" + s + "\\]"; }

  function p(seed,a,b){ return a + (seed % 101); }
  function q(seed,a,b){ return a + ((seed*3 + 1) % 101); }
  function r(seed,a,b){ return a + ((seed*7 + 2) % 101); }
  ...
  return {TOTAL,generar,generarIndice,contar,contarUnicos};
})();
